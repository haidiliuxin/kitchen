...
export function HomeScreen(props: HomeScreenProps) {
  ...
  }, [isDetailOpen, homeSubpage, props.selectedRecipe?.id])
        ...
        <main className="mobile-page-stack">
          <section className="panel mobile-page-section">
            ...
            <div className="import-result-list">
              {topicCards.map((item) => (
                <article key={item.title} className="import-result-item">
                  <span>专题入口</span>
  ...
  if (isDetailOpen && props.selectedRecipe) {
    return (
      <main className="mobile-page-stack recipe-detail-screen">
        <header className="recipe-detail-topbar">
          <button
            className="back-button ghost-button small-button"
            onClick={() => {
              setIsDetailOpen(false)
        ...
        <section className="panel mobile-page-section recipe-detail-page">
          ...
          <div className="detail-stack">
            <section className="detail-block detail-block-emphasis">
              <div className="section-heading compact-heading">
                <div>
            ...
            <section className="detail-block detail-summary-card">
        ...
        <div className="recipe-detail-bottom-bar">
          <div className="detail-actions">
            <button className="ghost-button" onClick={() => props.onToggleFavorite(props.selectedRecipe!.id)}>
  ...
  return (
    <main className="mobile-page-stack">
      {ongoingRecipe && props.ongoingCookingSession ? (
        <section className="panel mobile-page-section community-entry-card home-resume-section">
          <button
            type="button"
      ...
      <section className="panel mobile-page-section home-search-entry-panel">
      ...
      <section className="panel mobile-page-section home-shortcut-section">
        <div className="section-heading compact-heading">
          <div>
        ...
        <div className="home-shortcut-grid home-shortcut-grid-triple">
          <button type="button" className="home-shortcut-card home-shortcut-card-compact" onClick={() => openHomeSubpage('topics')}>
            <span>专题</span>
            <strong>专题推荐</strong>
            <p>15 分钟快手菜、新手第一次做饭</p>
          </button>
          <button type="button" className="home-shortcut-card home-shortcut-card-compact" onClick={() => openHomeSubpage('history')}>
            <span>记录</span>
            <strong>最近做过</strong>
            <p>查看最近做过和最近打开的菜谱</p>
          </button>
          <button type="button" className="home-shortcut-card home-shortcut-card-compact" onClick={() => openHomeSubpage('filters')}>
            <span>筛选</span>
            <strong>更多筛选</strong>
          </button>
        </div>
        ...
        <section className="panel mobile-page-section">
          ...
          <div className="card-list">
            {favoriteRecipes.slice(0, 2).map((recipe) => (
              <button key={recipe.id} className="recipe-card" onClick={() => openRecipeDetail(recipe.id)}>
      ...
      <section className="panel mobile-page-section home-featured-section">
      ...
      <section className="panel mobile-page-section home-recipe-list-section">
        ...
        {props.recipesError ? (
          ...
          <div className="card-list">
            {props.recipesData.length > 0 ? (
              props.recipesData.slice(0, 1).map((recipe) => (
                <button key={recipe.id} className="recipe-card" onClick={() => openRecipeDetail(recipe.id)}>
                  <div className="recipe-card-cover" style={recipeCardStyle(recipe)}>
                    <span>{recipe.scene}</span>
                    <strong>{recipe.highlight}</strong>
