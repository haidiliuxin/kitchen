  ...
  return (
    <main className="mobile-page-stack">
      <section className="panel mobile-page-section search-hero-card">
        ...
        <h1>热搜推荐</h1>
        <p className="search-hero-copy">快速找到适合当前场景的菜谱，支持菜名、食材和做法关键词。</p>
      </section>

      <section className="panel mobile-page-section search-input-section">
      ...
      {recentSearches.length > 0 ? (
        <section className="panel mobile-page-section search-recent-section">
      ...
      <section className="panel mobile-page-section search-category-section">
        <div className="section-heading compact-heading">
          <div>
          ...
          {hotSearches.map((item, index) => (
            ...
            >
              ...
              <div className="trending-copy">
                <h4>{item}</h4>
                <p>{index < 3 ? '点击后会直接带出相关结果。' : '后面可以继续接更完整的搜索结果流。'}</p>
              </div>
            </button>
          ))}
        </div>
